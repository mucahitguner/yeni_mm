...
class Opgunu extends StatefulWidget {
  const Opgunu({super.key});

  @override
  State<Opgunu> createState() => _OpgunuState();
}

class _OpgunuState extends State<Opgunu> {
  @override
  void initState() {
    super.initState();
  }
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Container(
                  child: Image.asset("lib/assets/images/ekip.png"),
                  margin: EdgeInsets.all(20),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Text(
                          "Merhaba, bugün operasyon günü ! Şimdiden geçmiş olsun.",
                          style: TextStyle(
                            height: 1.8,
                            fontSize: 16,
                          ),
                ...
                Container(
                  ...
                  child: Text(
                    "Size buradan 1 yıl boyunca sağlık danışmanlığı hizmeti veriyor olacağız. Size destek olmak adına bu süreçte birlikte olacağız.",
