...
class FotoYil extends StatefulWidget {
  const FotoYil({super.key});

  @override
  State<FotoYil> createState() => _FotoYilState();
}

class _FotoYilState extends State<FotoYil> {
  @override
              ...
              children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Text(
                          "Merhaba, Operasyon üzerinden 1 yıl geçti. Sizi merak ediyoruz.",
                          style: TextStyle(
                            height: 1.8,
                            fontSize: 16,
                          ),
                ...
                Container(
                  ...
                  child: GradientElevatedButton.icon(
                    ...
                    onPressed: () async {
                      launchUrl(Uri.parse("https://wa.me/905068374685"));
                    },
