...
class FotoUcuncuGun extends StatefulWidget {
  const FotoUcuncuGun({super.key});

  @override
  State<FotoUcuncuGun> createState() => _FotoUcuncuGunState();
}

class _FotoUcuncuGunState extends State<FotoUcuncuGun> {
  @override
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Container(
                  child: Image.asset("lib/assets/images/resim-acilari.png"),
                  margin: EdgeInsets.all(20),
                ),
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Text(
                          "Merhaba, Operasyon umarız iyi geçmiştir. Sizi merak ediyoruz.",
                          style: TextStyle(
                            height: 1.8,
                            fontSize: 16,
                          ),
                ...
                Container(
                  ...
                  child: Text(
                    "Müsait olduğunuzda tüm açılardan kontrol amaçlı fotoğraflarınızı aşağıdaki linkten gönderebilir misiniz ?",
                ...
                Container(
                  ...
                  child: GradientElevatedButton.icon(
                    ...
                    onPressed: () async {
                      await launchUrl(Uri.parse("https://wa.me/905068374685"));
                    },
                    ...
                    label: Text("Whatsapp Foto Gönder"),
                  ),
                ),
                Container(
                    margin: EdgeInsets.only(top: 30),
